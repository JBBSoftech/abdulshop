...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/abdulshop_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '694a9e784c1fdfa632898193',
      shopName: 'abdulshop',
...
app.listen(PORT, () => {
  console.log(`abdulshop Backend Server running on port ${PORT}`);
});
